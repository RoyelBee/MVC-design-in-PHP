...
<head>
  ...
  <title>OOP PHP with MVC design pattern</title>
<style>
...
<body>
  <header class="headeroption">
    <h2>Object Oriented PHP with MVC</h2>
  </header>
<div class="content">
<section class="subject">
<p>Select event using MVC<span style="float:right"><a href="index.php">Create New</a></span><p>
</section>